# Source First Profit-Shared License (SFPS)

This license is derived over https://www.futo.org/about/futo-statement-on-opensource/

## Acceptance
By using the software, you agree to all of the terms and conditions below.

## Copyright License
Plein (anonym) grants you a non-exclusive, royalty-free, worldwide, non-sublicensable, non-transferable license to use, copy, distribute, make available, and prepare derivative works of the software, in each case subject to the limitations below.
...
## Definitions
- The “Licensor” is the entity offering these terms, Plein (anonym).
...
If your company derives any profit based on the software, you MUST pay a negotiated share to us, and the contributors of upstream libraries. 